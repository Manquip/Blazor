    ...
    public class EmployeeBusiness
    {
        public static List<Employee> EmployeesList()        
        {
            var list = new List<Employee> { 
                 ...
                 new Employee{Id="EL125-9", Name="Marina Buendía", BossId="EL000-8"},
        ...
        public static List<Employee> EmployeesByBoss(string bossId)
        {
            var list = EmployeesList().Where(emp => emp.BossId == bossId);
